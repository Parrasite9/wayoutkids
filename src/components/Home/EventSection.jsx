                ...
                <div>
                    ...
                    {/* Div3: First image in first column, first row */}
                        <div className="col-start-1 col-end-2 row-start-1 row-end-2">
                            <img className="w-full h-full object-cover rounded-t-xl" src="/images/events/paint.jpg" alt="Image 1" />
                        </div> 


                
                    {nextEvent ? (
                        <div className="relative bg-softOrange p-5 flex items-start justify-start text-lef mb-8 rounded-b-xl">
                        ...
                        <div className="col-start-1 col-end-2 row-start-2 row-end-3">
                            <img className="w-full h-full object-cover rounded-t-xl" src="/images/events/jenga.jpg" alt="Image 2" />
                        </div>
