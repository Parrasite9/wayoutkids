...
<div className="grid grid-cols-1 grid-rows-7 gap-0 md:grid-cols-4 md:grid-rows-7 md:gap-2">
  ...
  <div className="md:row-start-2 md:row-end-5 md:col-start-3 md:col-end-5">
    <img className="w-full h-full object-cover mb-2" src="/images/about3.avif" alt="Image 3" />
        ...
        <>
            {/* DESKTOP VIEW  */}
            <div class="grid grid-cols-2 grid-rows-1 gap-0 bg-custom-gradient">
                {/* <!-- IMAGE CONTAINER--> */}
